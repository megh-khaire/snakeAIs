...
class PauseMenuScreen:
    ...
    def _setup_buttons(self, screen_center_x):
        ...
        num_buttons = 4
        total_button_height = (num_buttons * self.button_height) + (
        ...
        button_definitions = [
            ...
            {
                "text": "Restart Game",
                "action": actions.ACTION_RESTART_GAME,
                "border_color": colors.GREEN,
            },
            {
                "text": "Main Menu",
            ...
            {
                "text": "Quit Game",
                "action": actions.ACTION_QUIT_GAME,
    ...
    def draw(self):
        ...
        title_rect = title_surface.get_rect(
            center=(self.display.get_width() // 2, title_y_pos)
        )
        ...
        for button in self.buttons:
            pygame.draw.rect(
                self.display, button["base_color"], button["rect"]
            )  # Button face
            pygame.draw.rect(
                self.display, button["border_color"], button["rect"], border_thickness
            )  # Border
